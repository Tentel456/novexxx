          ...
          <div className="hidden lg:flex items-center gap-4 flex-shrink-0">
            ...
            {loading ? (
              ...
              <>
                <Link
                  href="/auth"
                  className="px-5 py-3 text-sm font-semibold text-[#2b6aff] border border-[#2b6aff] rounded-xl hover:bg-[#2b6aff]/6 transition"
                >
                  Войти
                </Link>
                <Link
                  href="/auth"
                  className="px-5 py-3 text-sm font-semibold text-white bg-[#2b6aff] border border-[#2b6aff] rounded-xl hover:bg-[#1f5ae6] transition"
                >
                  Регистрация
                </Link>
              </>
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden fixed inset-0 z-[1000] bg-black/50" onClick={() => setIsMobileMenuOpen(false)}>
          <div className="absolute right-0 top-0 h-full w-80 bg-white shadow-2xl p-8 overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            ...
            {/* Profile in Mobile (if logged in) */}
            {user && (
            ...
            <nav className={`flex flex-col gap-6 ${user ? '' : 'mt-12'}`}>
            ...
            {!user && (
              <div className="mt-8 flex flex-col gap-4">
                <Link href="/auth" className="w-full text-center px-6 py-3 text-[#2b6aff] border border-[#2b6aff] rounded-xl hover:bg-[#2b6aff]/6 font-semibold">
                  Войти
                </Link>
                <Link href="/auth" className="w-full text-center px-6 py-3 bg-[#2b6aff] text-white rounded-xl hover:bg-[#1f5ae6] font-semibold">
                  Регистрация
                </Link>
              </div>
            )}
